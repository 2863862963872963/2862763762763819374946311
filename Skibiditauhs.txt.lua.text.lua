            ...
            function v.Dialog(N, O)
                ...
                local Q =
                    ...
                    "TextLabel",
                    {
                        ...
                        Position = UDim2.fromOffset(78, 80),
                        BackgroundTransparency = 1,
                        Parent = P.Root,
...
[27] = function()
    ...
    [53] = function()
        ...
        return {
            ...
            ElementTransparency = 0.86,
            ToggleSlider = Color3.fromRGB(177,143,106),
            ...
            DropdownBorder = Color3.fromRGB(130, 90, 110),
            DropdownOption = Color3.fromRGB(204,174,136),
            Keybind = Color3.fromRGB(177,143,106),
            Input = Color3.fromRGB(177,143,106),
            InputFocused = Color3.fromRGB(177,143,106),
            InputIndicator = Color3.fromRGB(177,143,106),
            Dialog = Color3.fromRGB(138,98,74),
            DialogHolder = Color3.fromRGB(138,98,74),
            DialogHolderLine = Color3.fromRGB(138,98,74),
            DialogButton = Color3.fromRGB(118,86,64),
            DialogButtonBorder = Color3.fromRGB(40, 40, 40),
            DialogBorder = Color3.fromRGB(40, 40, 40),
            DialogInput = Color3.fromRGB(118,86,64),
            DialogInputLine = Color3.fromRGB(118,86,64),
            Text = Color3.fromRGB(240, 240, 240),
            SubText = Color3.fromRGB(170, 170, 170),
    ...
    return {
        ...
        ElementBorder = Color3.fromRGB(40, 0, 0), 
        InElementBorder = Color3.fromRGB(70, 0, 0), 
        ElementTransparency = 0.9,
        ToggleSlider = Color3.fromRGB(80, 0, 0), 
        ToggleToggled = Color3.fromRGB(0, 0, 0),
        SliderRail = Color3.fromRGB(80, 0, 0),
        DropdownFrame = Color3.fromRGB(90, 0, 0), 
        DropdownHolder = Color3.fromRGB(40, 0, 0), 
        DropdownBorder = Color3.fromRGB(30, 0, 0), 
        DropdownOption = Color3.fromRGB(80, 0, 0), 
        Keybind = Color3.fromRGB(80, 0, 0), 
        Input = Color3.fromRGB(80, 0, 0), 
        InputFocused = Color3.fromRGB(30, 0, 0), 
        InputIndicator = Color3.fromRGB(90, 0, 0), 
        Dialog = Color3.fromRGB(40, 0, 0), 
        DialogHolder = Color3.fromRGB(35, 0, 0), 
        DialogHolderLine = Color3.fromRGB(30, 0, 0), 
        DialogButton = Color3.fromRGB(40, 0, 0), 
        DialogButtonBorder = Color3.fromRGB(75, 0, 0), 
        DialogBorder = Color3.fromRGB(60, 0, 0), 
        DialogInput = Color3.fromRGB(50, 0, 0), 
        DialogInputLine = Color3.fromRGB(100, 0, 0), 
