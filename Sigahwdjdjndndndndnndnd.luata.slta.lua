...
local HawkLib = {
    ...
    Shadow = Color3.fromRGB(255, 171, 130),
    TitleBar = Color3.fromRGB(255, 204, 92),
    TabBefore = Color3.fromRGB(255, 159, 67),
    TabAfter = Color3.fromRGB(250, 128, 114),
    TitleTextColor = Color3.fromRGB(44, 62, 80),
    TabTextColor = Color3.fromRGB(241, 196, 15),
    TitleLineColor = Color3.fromRGB(255, 87, 34),
    PageTitleColor = Color3.fromRGB(233, 30, 99),
    Selection = Color3.fromRGB(253, 121, 168),
    CloseMinimize = Color3.fromRGB(69, 90, 100),
    ItemColors = Color3.fromRGB(255, 215, 0),
    ItemTitleColors = Color3.fromRGB(255, 111, 97),
    ItemTextColors = Color3.fromRGB(255, 199, 44),
    ItemTextBoxKeyBindColors = Color3.fromRGB(250, 197, 152),
    ItemTextBoxKeyBindStrokeColors = Color3.fromRGB(255, 140, 105),
    ItemTextBoxTextColor = Color3.fromRGB(183, 149, 11),
    ItemKeyBindTextColor = Color3.fromRGB(229, 57, 53),
    ToggleTickColor = Color3.fromRGB(156, 39, 176),
    ButtonClickIconColor = Color3.fromRGB(255, 87, 34),
    ButtonHover = Color3.fromRGB(255, 193, 7),      
    SliderButtonFrameColor = Color3.fromRGB(255, 152, 0),
    InSliderFrame = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 87, 34)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 193, 7))},
    NumColor = Color3.fromRGB(255, 235, 59),
    DropdownColorPickerImageArrowColors = Color3.fromRGB(255, 171, 64),
    NotificationNotifyColor = Color3.fromRGB(245, 0, 87),
    NotificationNotifyTitleColor = Color3.fromRGB(156, 39, 176),
    NotificationNotifyTextColor = Color3.fromRGB(103, 58, 183),
    IconColor = Color3.fromRGB(69, 90, 100),
    IconShadow = Color3.fromRGB(129, 212, 250),
    NotifyButtons = Color3.fromRGB(38, 198, 218)
		},
		OceanBreeze = {
    Main = Color3.fromRGB(72, 207, 173),
    Shadow = Color3.fromRGB(129, 236, 236),
    TitleBar = Color3.fromRGB(84, 160, 255),
    TabBefore = Color3.fromRGB(116, 185, 255),
    TabAfter = Color3.fromRGB(9, 132, 227),
    TitleTextColor = Color3.fromRGB(25, 42, 86),
    TabTextColor = Color3.fromRGB(223, 230, 233),
    TitleLineColor = Color3.fromRGB(6, 82, 221),
    PageTitleColor = Color3.fromRGB(52, 31, 151),
    Selection = Color3.fromRGB(108, 92, 231),
    CloseMinimize = Color3.fromRGB(200, 214, 229),
    ItemColors = Color3.fromRGB(41, 128, 185),
    ItemTitleColors = Color3.fromRGB(116, 185, 255),
    ItemTextColors = Color3.fromRGB(0, 184, 148),
    ItemTextBoxKeyBindColors = Color3.fromRGB(30, 144, 255),
    ItemTextBoxKeyBindStrokeColors = Color3.fromRGB(112, 161, 255),
    ItemTextBoxTextColor = Color3.fromRGB(54, 79, 107),
    ItemKeyBindTextColor = Color3.fromRGB(22, 160, 133),
    ToggleTickColor = Color3.fromRGB(6, 214, 160),
    ButtonClickIconColor = Color3.fromRGB(0, 206, 201),
    ButtonHover = Color3.fromRGB(255, 107, 107),        
    SliderButtonFrameColor = Color3.fromRGB(29, 209, 161),
    InSliderFrame = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(85, 239, 196)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 184, 148))},
    NumColor = Color3.fromRGB(0, 206, 201),
    DropdownColorPickerImageArrowColors = Color3.fromRGB(76, 209, 55),
    NotificationNotifyColor = Color3.fromRGB(162, 155, 254),
    NotificationNotifyTitleColor = Color3.fromRGB(45, 52, 54),
    NotificationNotifyTextColor = Color3.fromRGB(72, 126, 176),
    IconColor = Color3.fromRGB(9, 132, 227),
    IconShadow = Color3.fromRGB(85, 239, 196),
    NotifyButtons = Color3.fromRGB(253, 121, 168)
		},
LavenderTown = {
    Main = Color3.fromRGB(204, 153, 255),      -- Soft Lavender
    Shadow = Color3.fromRGB(153, 102, 204),    -- Deep Lavender
    TitleBar = Color3.fromRGB(153, 153, 255),  -- Light Purple
    TabBefore = Color3.fromRGB(175, 160, 255), -- Muted Purple
    TabAfter = Color3.fromRGB(221, 214, 255),  -- Pale Lavender
    TitleTextColor = Color3.fromRGB(85, 26, 139), -- Deep Purple
    TabTextColor = Color3.fromRGB(128, 0, 128),   -- Medium Purple
    TitleLineColor = Color3.fromRGB(139, 0, 139), -- Dark Magenta
    PageTitleColor = Color3.fromRGB(76, 0, 153),  -- Royal Purple
    Selection = Color3.fromRGB(238, 130, 238),   -- Violet
    CloseMinimize = Color3.fromRGB(102, 0, 204), -- Electric Indigo
    ItemColors = Color3.fromRGB(186, 85, 211),   -- Medium Orchid
    ItemTitleColors = Color3.fromRGB(147, 112, 219), -- Medium Purple
    ItemTextColors = Color3.fromRGB(75, 0, 130), -- Indigo
    ItemTextBoxKeyBindColors = Color3.fromRGB(230, 230, 250), -- Lavender
    ItemTextBoxKeyBindStrokeColors = Color3.fromRGB(148, 0, 211), -- Dark Violet
    ItemTextBoxTextColor = Color3.fromRGB(138, 43, 226), -- Blue Violet
    ItemKeyBindTextColor = Color3.fromRGB(153, 50, 204), -- Dark Orchid
    ToggleTickColor = Color3.fromRGB(72, 61, 139), -- Slate Blue
    ButtonClickIconColor = Color3.fromRGB(123, 104, 238), -- Medium Slate Blue
    ButtonHover = Color3.fromRGB(191, 62, 255),    -- Purple
    SliderButtonFrameColor = Color3.fromRGB(216, 191, 216), -- Thistle
    InSliderFrame = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(186, 85, 211)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(148, 0, 211))}, -- Medium Orchid to Dark Violet
    NumColor = Color3.fromRGB(75, 0, 130),       -- Indigo
    DropdownColorPickerImageArrowColors = Color3.fromRGB(138, 43, 226), -- Blue Violet
    NotificationNotifyColor = Color3.fromRGB(230, 230, 250), -- Lavender
    NotificationNotifyTitleColor = Color3.fromRGB(85, 26, 139), -- Deep Purple
    NotificationNotifyTextColor = Color3.fromRGB(76, 0, 153),  -- Royal Purple
    IconColor = Color3.fromRGB(139, 0, 139), -- Dark Magenta
    IconShadow = Color3.fromRGB(255, 255, 255), -- White
    NotifyButtons = Color3.fromRGB(123, 104, 238) -- Medium Slate Blue
		},
